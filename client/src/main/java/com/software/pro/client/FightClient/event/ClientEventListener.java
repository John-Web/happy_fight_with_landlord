...
public abstract class ClientEventListener {
	...
	private final static String LISTENER_PREFIX = "com.software.pro.client.FightClient.event.ClientEventListener_";
	
	protected static List<Poker> lastPokers = null;
	protected static String lastSellClientPlayername = null;
	protected static String lastSellClientType = null;
	
	protected static void initLastSellInfo() {
		lastPokers = null;
		lastSellClientPlayername = null;
